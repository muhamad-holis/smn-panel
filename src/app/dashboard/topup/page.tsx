    ...
    return (
      <div className="mx-auto max-w-md">
        <div className="card text-center">
          ...
          <p className="mt-1 text-sm text-gray-400">Invoice: {payment.invoice_id}</p>
          ...
          {payment.qr_image && (
            <div className="mx-auto mt-6 w-56">
              <img src={payment.qr_image} alt="QRIS" className="w-full rounded-lg border border-gray-100" />
            </div>
          )}
