  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      {Object.keys(grouped).length === 0 && (
        <p className="text-gray-500">Belum ada layanan tersedia. Silakan cek kembali nanti.</p>
      )}
                ...
                {list!.map((s) => (
                  <tr key={s.id}>
                    ...
                    <td className="px-4 py-3">
                      {s.refill ? (
                        <span className="rounded-full bg-green-100 px-2 py-0.5 text-xs text-green-700">Ya</span>
                      ) : (
